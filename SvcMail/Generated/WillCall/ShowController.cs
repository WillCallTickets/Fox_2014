...
namespace Wcss
{
    ...
    public partial class ShowController
    {
	    ...
	    public void Insert(string Name,DateTime? DtAnnounceDate,DateTime? DtDateOnSale,bool BActive,bool BSoldOut,string ShowAlert,int TVenueId,string DisplayNotes,string ShowTitle,string DisplayUrl,int IPicWidth,int IPicHeight,string ShowHeader,string ShowWriteup,DateTime DtStamp,Guid ApplicationId,bool BCtrX,bool BCtrY,string FacebookEventUrl,string VcPrincipal)
	    {
		    Show item = new Show();
