...
namespace Wcss
{
	...
	public partial class EmailLetter : ActiveRecord<EmailLetter>, IActiveRecord
	{
		...
		{
			return new Wcss.MailQueueCollection().Where(MailQueue.Columns.TEmailLetterId, Id).Load();
		}
		public Wcss.SubscriptionEmailCollection SubscriptionEmailRecords()
		{
			return new Wcss.SubscriptionEmailCollection().Where(SubscriptionEmail.Columns.TEmailLetterId, Id).Load();
		}
		#endregion
