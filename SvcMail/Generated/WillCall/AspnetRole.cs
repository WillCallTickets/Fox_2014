...
namespace Wcss
{
	...
	public partial class AspnetRole : ActiveRecord<AspnetRole>, IActiveRecord
	{
		...
		{
			return new Wcss.AspnetUsersInRoleCollection().Where(AspnetUsersInRole.Columns.RoleId, RoleId).Load();
		}
		public Wcss.SubscriptionCollection SubscriptionRecords()
		{
			return new Wcss.SubscriptionCollection().Where(Subscription.Columns.RoleId, RoleId).Load();
		}
		#endregion
