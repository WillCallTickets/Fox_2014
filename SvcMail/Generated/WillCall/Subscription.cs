...
namespace Wcss
{
	...
	public partial class Subscription : ActiveRecord<Subscription>, IActiveRecord
	{
		...
		{
			return new Wcss.SubscriptionUserCollection().Where(SubscriptionUser.Columns.TSubscriptionId, Id).Load();
		}
		public Wcss.SubscriptionEmailCollection SubscriptionEmailRecords()
		{
			return new Wcss.SubscriptionEmailCollection().Where(SubscriptionEmail.Columns.TSubscriptionId, Id).Load();
		}
		#endregion
		...
		/// 
		/// </summary>
		public Wcss.AspnetRole AspnetRole
		{
