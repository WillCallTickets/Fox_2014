...
namespace Wcss
{
	...
	public partial class SubscriptionEmail : ActiveRecord<SubscriptionEmail>, IActiveRecord
	{
		...
		{
			return new Wcss.HistorySubscriptionEmailCollection().Where(HistorySubscriptionEmail.Columns.TSubscriptionEmailId, Id).Load();
		}
		public Wcss.MailQueueCollection MailQueueRecords()
		{
			return new Wcss.MailQueueCollection().Where(MailQueue.Columns.TSubscriptionEmailId, Id).Load();
		}
		#endregion
		...
		/// 
		/// </summary>
		public Wcss.EmailLetter EmailLetter
		{
		...
		/// 
		/// </summary>
		public Wcss.Subscription Subscription
		{
