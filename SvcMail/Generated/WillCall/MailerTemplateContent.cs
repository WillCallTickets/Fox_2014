...
namespace Wcss
{
	...
	public partial class MailerTemplateContent : ActiveRecord<MailerTemplateContent>, IActiveRecord
	{
		...
		{
			return new Wcss.MailerContentCollection().Where(MailerContent.Columns.TMailerTemplateContentId, Id).Load();
		}
		public Wcss.MailerTemplateSubstitutionCollection MailerTemplateSubstitutionRecords()
		{
			return new Wcss.MailerTemplateSubstitutionCollection().Where(MailerTemplateSubstitution.Columns.TMailerTemplateContentId, Id).Load();
		}
		#endregion
		...
		/// 
		/// </summary>
		public Wcss.MailerTemplate MailerTemplate
		{
