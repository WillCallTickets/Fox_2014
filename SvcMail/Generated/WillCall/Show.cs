...
namespace Wcss
{
	...
	public partial class Show : ActiveRecord<Show>, IActiveRecord
	{
		...
		{
			return new Wcss.JShowPromoterCollection().Where(JShowPromoter.Columns.TShowId, Id).Load();
		}
		public Wcss.KioskCollection KioskRecords()
		{
			return new Wcss.KioskCollection().Where(Kiosk.Columns.TShowId, Id).Load();
		}
		public Wcss.ShowDateCollection ShowDateRecords()
		{
			return new Wcss.ShowDateCollection().Where(ShowDate.Columns.TShowId, Id).Load();
		}
		public Wcss.ShowGenreCollection ShowGenreRecords()
		{
			return new Wcss.ShowGenreCollection().Where(ShowGenre.Columns.TShowId, Id).Load();
		}
		public Wcss.ShowLinkCollection ShowLinkRecords()
		{
			return new Wcss.ShowLinkCollection().Where(ShowLink.Columns.TShowId, Id).Load();
		}
		public Wcss.VdShowExpenseCollection VdShowExpenseRecords()
		{
			return new Wcss.VdShowExpenseCollection().Where(VdShowExpense.Columns.TShowId, Id).Load();
		}
		public Wcss.VdShowGenreCollection VdShowGenreRecords()
		{
			return new Wcss.VdShowGenreCollection().Where(VdShowGenre.Columns.TShowId, Id).Load();
		}
		public Wcss.VdShowInfoCollection VdShowInfoRecords()
		{
			return new Wcss.VdShowInfoCollection().Where(VdShowInfo.Columns.TShowId, Id).Load();
		}
		public Wcss.VdShowTicketCollection VdShowTicketRecords()
		{
			return new Wcss.VdShowTicketCollection().Where(VdShowTicket.Columns.TShowId, Id).Load();
		}
		public Wcss.VdShowTicketOutletCollection VdShowTicketOutletRecords()
		{
			return new Wcss.VdShowTicketOutletCollection().Where(VdShowTicketOutlet.Columns.TShowId, Id).Load();
		}
		#endregion
