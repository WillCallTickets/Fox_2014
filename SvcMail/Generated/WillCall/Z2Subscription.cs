...
namespace Wcss
{
	...
	public partial class Z2Subscription : ActiveRecord<Z2Subscription>, IActiveRecord
	{
		...
		{
			return new Wcss.Z2SubscriptionRequestCollection().Where(Z2SubscriptionRequest.Columns.TZ2SubscriptionId, Id).Load();
		}
		public Wcss.Z2SubscriptionTransferCollection Z2SubscriptionTransferRecords()
		{
			return new Wcss.Z2SubscriptionTransferCollection().Where(Z2SubscriptionTransfer.Columns.TZ2SubscriptionId, Id).Load();
		}
		#endregion
