...
namespace Wcss
{
	...
	public partial class AspnetApplication : ActiveRecord<AspnetApplication>, IActiveRecord
	{
		...
		{
			return new Wcss.AspnetMembershipCollection().Where(AspnetMembership.Columns.ApplicationId, ApplicationId).Load();
		}
		public Wcss.AspnetPathCollection AspnetPaths()
		{
			return new Wcss.AspnetPathCollection().Where(AspnetPath.Columns.ApplicationId, ApplicationId).Load();
		}
		public Wcss.AspnetRoleCollection AspnetRoles()
		{
			return new Wcss.AspnetRoleCollection().Where(AspnetRole.Columns.ApplicationId, ApplicationId).Load();
		}
		public Wcss.AspnetUserCollection AspnetUsers()
		{
			return new Wcss.AspnetUserCollection().Where(AspnetUser.Columns.ApplicationId, ApplicationId).Load();
		}
		public Wcss.ActCollection ActRecords()
		{
			return new Wcss.ActCollection().Where(Act.Columns.ApplicationId, ApplicationId).Load();
		}
		public Wcss.AgeCollection AgeRecords()
		{
			return new Wcss.AgeCollection().Where(Age.Columns.ApplicationId, ApplicationId).Load();
		}
		public Wcss.EmailLetterCollection EmailLetterRecords()
		{
			return new Wcss.EmailLetterCollection().Where(EmailLetter.Columns.ApplicationId, ApplicationId).Load();
		}
		public Wcss.EmployeeCollection EmployeeRecords()
		{
			return new Wcss.EmployeeCollection().Where(Employee.Columns.ApplicationId, ApplicationId).Load();
		}
		public Wcss.EventQCollection EventQRecords()
		{
			return new Wcss.EventQCollection().Where(EventQ.Columns.ApplicationId, ApplicationId).Load();
		}
		public Wcss.FaqCategorieCollection FaqCategorieRecords()
		{
			return new Wcss.FaqCategorieCollection().Where(FaqCategorie.Columns.ApplicationId, ApplicationId).Load();
		}
		public Wcss.HintQuestionCollection HintQuestionRecords()
		{
			return new Wcss.HintQuestionCollection().Where(HintQuestion.Columns.ApplicationId, ApplicationId).Load();
		}
		public Wcss.MailQueueCollection MailQueueRecords()
		{
			return new Wcss.MailQueueCollection().Where(MailQueue.Columns.ApplicationId, ApplicationId).Load();
		}
		public Wcss.PromoterCollection PromoterRecords()
		{
			return new Wcss.PromoterCollection().Where(Promoter.Columns.ApplicationId, ApplicationId).Load();
		}
		public Wcss.KioskCollection KioskRecords()
		{
			return new Wcss.KioskCollection().Where(Kiosk.Columns.ApplicationId, ApplicationId).Load();
		}
		public Wcss.SalePromotionCollection SalePromotionRecords()
		{
			return new Wcss.SalePromotionCollection().Where(SalePromotion.Columns.ApplicationId, ApplicationId).Load();
		}
		public Wcss.ShowCollection ShowRecords()
		{
			return new Wcss.ShowCollection().Where(Show.Columns.ApplicationId, ApplicationId).Load();
		}
		public Wcss.SiteConfigCollection SiteConfigRecords()
		{
			return new Wcss.SiteConfigCollection().Where(SiteConfig.Columns.ApplicationId, ApplicationId).Load();
		}
		public Wcss.SubscriptionCollection SubscriptionRecords()
		{
			return new Wcss.SubscriptionCollection().Where(Subscription.Columns.ApplicationId, ApplicationId).Load();
		}
		public Wcss.VenueCollection VenueRecords()
		{
			return new Wcss.VenueCollection().Where(Venue.Columns.ApplicationId, ApplicationId).Load();
		}
		#endregion
