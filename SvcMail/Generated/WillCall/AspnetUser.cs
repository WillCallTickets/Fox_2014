...
namespace Wcss
{
	...
	public partial class AspnetUser : ActiveRecord<AspnetUser>, IActiveRecord
	{
		...
		{
			return new Wcss.AspnetMembershipCollection().Where(AspnetMembership.Columns.UserId, UserId).Load();
		}
		public Wcss.AspnetPersonalizationPerUserCollection AspnetPersonalizationPerUserRecords()
		{
			return new Wcss.AspnetPersonalizationPerUserCollection().Where(AspnetPersonalizationPerUser.Columns.UserId, UserId).Load();
		}
		public Wcss.AspnetProfileCollection AspnetProfileRecords()
		{
			return new Wcss.AspnetProfileCollection().Where(AspnetProfile.Columns.UserId, UserId).Load();
		}
		public Wcss.AspnetUsersInRoleCollection AspnetUsersInRoles()
		{
			return new Wcss.AspnetUsersInRoleCollection().Where(AspnetUsersInRole.Columns.UserId, UserId).Load();
		}
		public Wcss.SubscriptionUserCollection SubscriptionUserRecords()
		{
			return new Wcss.SubscriptionUserCollection().Where(SubscriptionUser.Columns.UserId, UserId).Load();
		}
		#endregion
