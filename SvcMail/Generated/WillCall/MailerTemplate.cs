...
namespace Wcss
{
	...
	public partial class MailerTemplate : ActiveRecord<MailerTemplate>, IActiveRecord
	{
		...
		{
			return new Wcss.MailerCollection().Where(Mailer.Columns.TMailerTemplateId, Id).Load();
		}
		public Wcss.MailerTemplateContentCollection MailerTemplateContentRecords()
		{
			return new Wcss.MailerTemplateContentCollection().Where(MailerTemplateContent.Columns.TMailerTemplateId, Id).Load();
		}
		#endregion
