...
namespace Wcss
{
	...
	public partial class AspnetPath : ActiveRecord<AspnetPath>, IActiveRecord
	{
		...
		{
			return new Wcss.AspnetPersonalizationAllUserCollection().Where(AspnetPersonalizationAllUser.Columns.PathId, PathId).Load();
		}
		public Wcss.AspnetPersonalizationPerUserCollection AspnetPersonalizationPerUserRecords()
		{
			return new Wcss.AspnetPersonalizationPerUserCollection().Where(AspnetPersonalizationPerUser.Columns.PathId, PathId).Load();
		}
		#endregion
