...
namespace Wcss
{
    public partial class Promoter : _AlphaOrderedEntity.IAlphaOrderedEntity
    {
        ...
        private string path_original
        {
            get
            {
                return (this.PictureUrl != null && this.PictureUrl.Trim().Length > 0) ?
                    string.Format("{0}{1}", _Config._PromoterImageStorage_Local, this.PictureUrl) : string.Empty;
            }
        }
