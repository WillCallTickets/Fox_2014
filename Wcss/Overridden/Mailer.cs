...
namespace Wcss
{
    #region MailerTemplate

    public partial class MailerTemplate 
    {
        public bool Is3rdPartySender
        {
            get
            {
                return (this.BThirdPartySender.HasValue) ? this.BThirdPartySender.Value : false;
            }
            set
            {
                this.BThirdPartySender = value;
            }
        }
    }
    ...
    {
        public const string tagTracking = "<TRACKING>"; 
                ...
                foreach (DataRow row in ds.Tables[0].Rows)
                {
                    ...
                    if (s != null)
                    {
                        ...
                        this.ShowEventRecords.AddToCollection(this.Id, ShowEvent.OwnerTypes.MailerContent, s.Id, ShowEvent.ParentTypes.Show, false,
                            date, s.ShowAlert, s.ShowTitle, s.Display.Promoters_NoMarkup_NoLinks, s.ShowHeader_Derived, s.Display.Headliners_NoMarkup_Verbose_NoLinks, 
