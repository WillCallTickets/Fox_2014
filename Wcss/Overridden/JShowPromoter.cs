...
namespace Wcss
{
    ...
    public partial class JShowPromoter : Utils._Collection.IDisplayOrderable
    {
        ...
        {
            return Utils.ParseHelper.ReplaceExtraWhitespaces(string.Format("{0} {1} {2} {3}",
                this.PreText ?? string.Empty,
                this.PromoterRecord.Name_Displayable,
                this.PromoterText ?? string.Empty,
