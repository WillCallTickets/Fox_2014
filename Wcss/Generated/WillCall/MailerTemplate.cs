	...
	public partial class MailerTemplate : ActiveRecord<MailerTemplate>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			if(!IsSchemaInitialized)
			{
				...
				TableSchema.TableColumn colvarBThirdPartySender = new TableSchema.TableColumn(schema);
				colvarBThirdPartySender.ColumnName = "bThirdPartySender";
				colvarBThirdPartySender.DataType = DbType.Boolean;
				colvarBThirdPartySender.MaxLength = 0;
				colvarBThirdPartySender.AutoIncrement = false;
				colvarBThirdPartySender.IsNullable = true;
				colvarBThirdPartySender.IsPrimaryKey = false;
				colvarBThirdPartySender.IsForeignKey = false;
				colvarBThirdPartySender.IsReadOnly = false;
				
						colvarBThirdPartySender.DefaultSetting = @"((0))";
				colvarBThirdPartySender.ForeignKeyTableName = "";
				schema.Columns.Add(colvarBThirdPartySender);
		...
		[XmlAttribute("BThirdPartySender")]
		[Bindable(true)]
		public bool? BThirdPartySender 
		{
			get { return GetColumnValue<bool?>(Columns.BThirdPartySender); }
			set { SetColumnValue(Columns.BThirdPartySender, value); }
		}
		...
		/// </summary>
		public static void Insert(DateTime varDtStamp,Guid varApplicationId,string varName,string varDescription,string varStyle,string varHeader,string varFooter,bool? varBThirdPartySender)
		{
			...
			item.BThirdPartySender = varBThirdPartySender;
		...
		/// </summary>
		public static void Update(int varId,DateTime varDtStamp,Guid varApplicationId,string varName,string varDescription,string varStyle,string varHeader,string varFooter,bool? varBThirdPartySender)
		{
			MailerTemplate item = new MailerTemplate();
        ...
        public static TableSchema.TableColumn BThirdPartySenderColumn
        {
		...
		public struct Columns
		{
			 ...
			 public static string BThirdPartySender = @"bThirdPartySender";
