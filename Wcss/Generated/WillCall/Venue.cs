...
namespace Wcss
{
	...
	public partial class Venue : ActiveRecord<Venue>, IActiveRecord
	{
		...
		/// </summary>
		public static void Insert(string varName,string varNameRoot,string varDisplayName,int? varICapacity,string varPictureUrl,int varIPicWidth,int varIPicHeight,string varWebsiteUrl,string varLatitude,string varLongitude,string varShortAddress,string varAddress,string varCity,string varState,string varZipCode,string varBoxOfficePhone,string varBoxOfficePhoneExt,string varBoxOfficeNotes,string varMainPhone,string varMainPhoneExt,string varNotes,DateTime varDtStamp,Guid varApplicationId,string varVcPrincipal)
		{
