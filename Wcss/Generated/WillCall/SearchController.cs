...
namespace Wcss
{
    ...
    public partial class SearchController
    {
	    ...
	    public void Insert(DateTime DtStamp,string VcContext,string Terms,int IResults,string EmailAddress,string IpAddress,string VcPrincipal)
	    {
	    ...
	    public void Update(int Id,DateTime DtStamp,string VcContext,string Terms,int IResults,string EmailAddress,string IpAddress,string VcPrincipal)
	    {
		    Search item = new Search();
	        item.MarkOld();
	        item.IsLoaded = true;
