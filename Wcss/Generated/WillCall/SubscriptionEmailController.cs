...
namespace Wcss
{
    ...
    public partial class SubscriptionEmailController
    {
	    ...
	    public void Insert(DateTime DtStamp,int TSubscriptionId,int TEmailLetterId,string PostedFileName,string CssFile,DateTime? DtLastSent,string ConstructedHtml,string ConstructedText,string FinalHtml)
	    {
	    ...
	    public void Update(int Id,DateTime DtStamp,int TSubscriptionId,int TEmailLetterId,string PostedFileName,string CssFile,DateTime? DtLastSent,string ConstructedHtml,string ConstructedText,string FinalHtml)
	    {
		    SubscriptionEmail item = new SubscriptionEmail();
	        item.MarkOld();
	        item.IsLoaded = true;
