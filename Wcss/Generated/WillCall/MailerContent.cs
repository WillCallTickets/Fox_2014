	...
	public partial class MailerContent : ActiveRecord<MailerContent>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			if(!IsSchemaInitialized)
			{
				...
				TableSchema.TableColumn colvarVcJsonContent = new TableSchema.TableColumn(schema);
				colvarVcJsonContent.ColumnName = "vcJsonContent";
				colvarVcJsonContent.DataType = DbType.AnsiString;
				colvarVcJsonContent.MaxLength = -1;
				colvarVcJsonContent.AutoIncrement = false;
				colvarVcJsonContent.IsNullable = true;
				colvarVcJsonContent.IsPrimaryKey = false;
				colvarVcJsonContent.IsForeignKey = false;
				colvarVcJsonContent.IsReadOnly = false;
				colvarVcJsonContent.DefaultSetting = @"";
				colvarVcJsonContent.ForeignKeyTableName = "";
				schema.Columns.Add(colvarVcJsonContent);
		...
		[XmlAttribute("VcJsonContent")]
		[Bindable(true)]
		public string VcJsonContent 
		{
			get { return GetColumnValue<string>(Columns.VcJsonContent); }
			set { SetColumnValue(Columns.VcJsonContent, value); }
		}
		...
		/// </summary>
		public static void Insert(DateTime varDtStamp,int varTMailerId,int varTMailerTemplateContentId,bool varBActive,string varVcTitle,string varVcContent,string varVcJsonContent)
		{
			...
			item.VcJsonContent = varVcJsonContent;
		...
		/// </summary>
		public static void Update(int varId,DateTime varDtStamp,int varTMailerId,int varTMailerTemplateContentId,bool varBActive,string varVcTitle,string varVcContent,string varVcJsonContent)
		{
			MailerContent item = new MailerContent();
        ...
        public static TableSchema.TableColumn VcJsonContentColumn
        {
		...
		public struct Columns
		{
			 ...
			 public static string VcJsonContent = @"vcJsonContent";
