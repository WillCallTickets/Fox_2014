...
namespace Wcss
{
    ...
    public partial class VenueController
    {
	    ...
	    public void Insert(string Name,string NameRoot,string DisplayName,int? ICapacity,string PictureUrl,int IPicWidth,int IPicHeight,string WebsiteUrl,string Latitude,string Longitude,string ShortAddress,string Address,string City,string State,string ZipCode,string BoxOfficePhone,string BoxOfficePhoneExt,string BoxOfficeNotes,string MainPhone,string MainPhoneExt,string Notes,DateTime DtStamp,Guid ApplicationId,string VcPrincipal)
	    {
