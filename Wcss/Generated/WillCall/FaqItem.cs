...
namespace Wcss
{
	...
	public partial class FaqItem : ActiveRecord<FaqItem>, IActiveRecord
	{
		...
		/// </summary>
		public static void Insert(DateTime varDtStamp,bool varBActive,string varQuestion,string varAnswer,int varTFaqCategorieId,string varVcPrincipal,string varVcJsonOrdinal)
		{
		...
		/// </summary>
		public static void Update(int varId,DateTime varDtStamp,bool varBActive,string varQuestion,string varAnswer,int varTFaqCategorieId,string varVcPrincipal,string varVcJsonOrdinal)
		{
			FaqItem item = new FaqItem();
