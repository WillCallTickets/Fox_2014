...
namespace Wcss
{
	...
	public partial class MailerTemplateContent : ActiveRecord<MailerTemplateContent>, IActiveRecord
	{
		...
		/// </summary>
		public static void Insert(DateTime varDtStamp,int varTMailerTemplateId,int varIDisplayOrder,string varVcTemplateAsset,string varName,string varNotes,string varTitle,string varTemplate,string varSeparatorTemplate,int varIMaxListItems,int varIMaxSelections,string varVcFlags)
		{
		...
		/// </summary>
		public static void Update(int varId,DateTime varDtStamp,int varTMailerTemplateId,int varIDisplayOrder,string varVcTemplateAsset,string varName,string varNotes,string varTitle,string varTemplate,string varSeparatorTemplate,int varIMaxListItems,int varIMaxSelections,string varVcFlags)
		{
			MailerTemplateContent item = new MailerTemplateContent();
