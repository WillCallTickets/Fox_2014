...
namespace Wcss
{
    ...
    public partial class MailerTemplateContentController
    {
	    ...
	    public void Insert(DateTime DtStamp,int TMailerTemplateId,int IDisplayOrder,string VcTemplateAsset,string Name,string Notes,string Title,string Template,string SeparatorTemplate,int IMaxListItems,int IMaxSelections,string VcFlags)
	    {
	    ...
	    public void Update(int Id,DateTime DtStamp,int TMailerTemplateId,int IDisplayOrder,string VcTemplateAsset,string Name,string Notes,string Title,string Template,string SeparatorTemplate,int IMaxListItems,int IMaxSelections,string VcFlags)
	    {
		    MailerTemplateContent item = new MailerTemplateContent();
	        item.MarkOld();
	        item.IsLoaded = true;
