...
namespace Wcss
{
    ...
    public partial class MailerTemplateController
    {
	    ...
	    public void Insert(DateTime DtStamp,Guid ApplicationId,string Name,string Description,string Style,string Header,string Footer,bool? BThirdPartySender)
	    {
            ...
            item.BThirdPartySender = BThirdPartySender;
	    ...
	    public void Update(int Id,DateTime DtStamp,Guid ApplicationId,string Name,string Description,string Style,string Header,string Footer,bool? BThirdPartySender)
	    {
		    MailerTemplate item = new MailerTemplate();
	        item.MarkOld();
	        item.IsLoaded = true;
