	...
	public partial class SubscriptionEmail : ActiveRecord<SubscriptionEmail>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			if(!IsSchemaInitialized)
			{
				...
				TableSchema.TableColumn colvarFinalHtml = new TableSchema.TableColumn(schema);
				colvarFinalHtml.ColumnName = "Final_Html";
				colvarFinalHtml.DataType = DbType.AnsiString;
				colvarFinalHtml.MaxLength = 2147483647;
				colvarFinalHtml.AutoIncrement = false;
				colvarFinalHtml.IsNullable = true;
				colvarFinalHtml.IsPrimaryKey = false;
				colvarFinalHtml.IsForeignKey = false;
				colvarFinalHtml.IsReadOnly = false;
				colvarFinalHtml.DefaultSetting = @"";
				colvarFinalHtml.ForeignKeyTableName = "";
				schema.Columns.Add(colvarFinalHtml);
		...
		[XmlAttribute("FinalHtml")]
		[Bindable(true)]
		public string FinalHtml 
		{
			get { return GetColumnValue<string>(Columns.FinalHtml); }
			set { SetColumnValue(Columns.FinalHtml, value); }
		}
		...
		/// </summary>
		public static void Insert(DateTime varDtStamp,int varTSubscriptionId,int varTEmailLetterId,string varPostedFileName,string varCssFile,DateTime? varDtLastSent,string varConstructedHtml,string varConstructedText,string varFinalHtml)
		{
		...
		/// </summary>
		public static void Update(int varId,DateTime varDtStamp,int varTSubscriptionId,int varTEmailLetterId,string varPostedFileName,string varCssFile,DateTime? varDtLastSent,string varConstructedHtml,string varConstructedText,string varFinalHtml)
		{
			SubscriptionEmail item = new SubscriptionEmail();
        ...
        public static TableSchema.TableColumn FinalHtmlColumn
        {
		...
		public struct Columns
		{
			 ...
			 public static string FinalHtml = @"Final_Html";
