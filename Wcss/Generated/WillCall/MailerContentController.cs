...
namespace Wcss
{
    ...
    public partial class MailerContentController
    {
	    ...
	    public void Insert(DateTime DtStamp,int TMailerId,int TMailerTemplateContentId,bool BActive,string VcTitle,string VcContent,string VcJsonContent)
	    {
            ...
            item.VcJsonContent = VcJsonContent;
	    ...
	    public void Update(int Id,DateTime DtStamp,int TMailerId,int TMailerTemplateContentId,bool BActive,string VcTitle,string VcContent,string VcJsonContent)
	    {
		    MailerContent item = new MailerContent();
	        item.MarkOld();
	        item.IsLoaded = true;
