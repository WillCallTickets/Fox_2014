...
namespace Wcss
{
    ...
    public partial class FaqItemController
    {
	    ...
	    public void Insert(DateTime DtStamp,bool BActive,string Question,string Answer,int TFaqCategorieId,string VcPrincipal,string VcJsonOrdinal)
	    {
	    ...
	    public void Update(int Id,DateTime DtStamp,bool BActive,string Question,string Answer,int TFaqCategorieId,string VcPrincipal,string VcJsonOrdinal)
	    {
		    FaqItem item = new FaqItem();
	        item.MarkOld();
	        item.IsLoaded = true;
