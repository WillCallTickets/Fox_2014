...
namespace Wcss
{
	...
	public partial class Search : ActiveRecord<Search>, IActiveRecord
	{
		...
		/// </summary>
		public static void Insert(DateTime varDtStamp,string varVcContext,string varTerms,int varIResults,string varEmailAddress,string varIpAddress,string varVcPrincipal)
		{
		...
		/// </summary>
		public static void Update(int varId,DateTime varDtStamp,string varVcContext,string varTerms,int varIResults,string varEmailAddress,string varIpAddress,string varVcPrincipal)
		{
			Search item = new Search();
