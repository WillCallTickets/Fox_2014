...
namespace Utils
{
    public class Validation
    {
        ...
        /// <param name="errors"></param>
        /// <returns></returns>
        public static string DisplayValidationErrors(System.Collections.Generic.List<string> errors)
        {
            if (errors.Count > 0)
            {
        ...
        public static bool DatesSpanMoreThanTwoDays(List<DateTime> dates)
        {
            if(dates.Count > 1)
                dates.Sort();
            return (dates[dates.Count - 1] >= dates[0].AddDays(2));
        }
        /// <summary>
