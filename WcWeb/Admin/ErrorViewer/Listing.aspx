<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Listing.aspx.cs" EnableViewState="false" Inherits="wctMain.Admin.ErrorViewer.Listing" Title="Admin - Error Viewer Listing" 
 MasterPageFile="/View/Masters/TemplateAdmin.master" %>
            ...
            <ContentTemplate>
                <div class="jqhead around">
                    <div class="sectitle">Error Listing
                        <asp:Button ID="btnArchive" CssClass="btn btn-primary btn-xs" runat="server" Text="Archive Events" OnClick="btnArchive_Click" CausesValidation="false" 
                ...
                <div style="border:none red 2px;position:relative;float:left; width:1280px;margin-top:10px;">
		            <div style="border:none blue 2px;position:relative;float:left; width:600px;">
		                <asp:FormView ID="FormView1" runat="server" DefaultMode="ReadOnly" DataKeyNames="Id" BackColor="#ffffff" 
		                    DataSourceID="SqlDataSource2" Width="100%" Font-Size="10px" OnDataBound="FormView1_DataBound">
		                    <ItemTemplate>
		                            <table border="1" cellspacing="0" cellpadding="3" >
							            ...
							            <tr><td colspan="2" ><div style="word-wrap:break-word;overflow-x:scroll;min-height:120px;max-width:600px;"><%# System.Web.HttpUtility.HtmlEncode(Eval("StackTrace").ToString())%></div></td></tr>
                            </table>
		                    </ItemTemplate>
		                </asp:FormView>
		                &nbsp;
		                                ...
		                                <div>
		                                    <span style="width:80px;padding:0 8px;">
		                                        <asp:Button ID="btnSelect" runat="server" Text='<%#Eval("Id") %>' CommandName="Select" 
		                                            ToolTip="Select" cssClass="btn btn-primary btn-xs" />
		                                    </span>
