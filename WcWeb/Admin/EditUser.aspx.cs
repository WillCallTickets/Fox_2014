...
namespace wctMain.Admin
{
    ...
    public partial class EditUser : MainBasePage
    {
        ...
        private void EventHandler_PointsUpdated(object sender, EventArgs e)
        {
            GridView1.DataBind();
        }
        ...
        {
            base.Redirect(string.Format("/Admin/_editors/CustomerEditor.aspx?p=sales&UserName={0}", userName));
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (userName == null || userName.Trim().Length == 0)
                base.Redirect("/Admin/_editors/CustomerEditor.aspx?p=customerpicker");
            ...
            if (!this.IsPostBack)
            {
                ...
                if (user != null)
                {
                    ...
                    litQuestion.DataBind();
                    if (this.Page.User.IsInRole("Super"))
                        litHintAnswer.DataBind();
                    ...
                    litUserIsEmailRoles.Text = litUserIsEmail.Text;
        ...
        protected void litQuestion_DataBinding(object sender, EventArgs e)
        {
            if(this.Page.User.IsInRole("PasswordViewer"))
            {
                Literal question = (Literal)sender;
        ...
        protected void btnReset_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                MailMessage email = new MailMessage(new MailAddress(_Config._CustomerService_Email, _Config._CustomerService_FromName),
                    new MailAddress((_Config._SiteIsInTestMode) ? _Config._Admin_EmailAddress : user.UserName));
        ...
        protected void chkRoles_DataBinding(object sender, EventArgs e)
        {
            ...
            allRoles.Remove("PasswordViewer");
        ...
        protected void chkRoles_DataBound(object sender, EventArgs e)
        {
            ...
            foreach (string role in allRoles)
            {
                ...
                if (li != null)
                {
                    ...
                    if (role == "Super")
                        li.Enabled = this.User.IsInRole("Super");
                }
            }
        }
