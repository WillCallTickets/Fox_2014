...
{
    public partial class Editor_Age : MainBaseControl
    {
        ...
        protected void listEnt_ItemUpdating(object sender, ListViewUpdateEventArgs e)
        {
            ...
            Age ent = (Age)_Lookits.Ages.Find((int)list.DataKeys[e.ItemIndex]["Id"]);
        ...
        {
            ListView list = (ListView)sender;
            _Lookits.Ages.DeleteAgeFromCollection((int)list.DataKeys[e.ItemIndex]["Id"]);
            e.Cancel = false;
            ExplicitBind();
        }
