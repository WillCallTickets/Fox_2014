<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Editor_Age.ascx.cs" Inherits="wctMain.Admin._editors._controls.Editor_Age" %>
<%@ Register assembly="WctControls" namespace="WctControls.WebControls" tagprefix="cc1" %>

<div id="ageseditor" class="show-mgmt">
    ...
    <div class="panel-body" >
        <asp:ListView ID="listEnt" ClientIDMode="Static" runat="server" EnableViewState="true" DataKeyNames="Id" 
            ...
            <LayoutTemplate>  
                <div id="age-items" class="orderable-items">
                    <ul>
