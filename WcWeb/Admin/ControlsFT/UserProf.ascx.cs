...
{
    public partial class UserProf : MainBaseControl
   {
      ...
      protected bool DisplayUserSubscriptions { get { return (this.Page.ToString().ToLower() != "asp.register_aspx"); } }
      ...
      public void BindPage(string userName)
      {
          ...
          if (this.UserName.Length > 0)
          {
              ...
              if (_Config._SubscriptionsActive)
              {
      ...
      protected void Page_Load(object sender, EventArgs e)
      {
       ...
       public void SaveProfile()
       {
          ...
          if ((!profile.IsAnonymous) && (profile.LegacyData.MemberSince == DateTime.MinValue || profile.LegacyData.MemberSince == System.Data.SqlTypes.SqlDateTime.MinValue))
           ...
           //because thie sub control is contained
