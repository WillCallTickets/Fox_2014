...
{
    public partial class Register : MainBaseControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else if(CreateUserWizard1.ActiveStep.ID == "profile")
                {
                    ...
                    wctMain.Admin.ControlsFT.UserProf userProfile = (wctMain.Admin.ControlsFT.UserProf)CreateUserWizard1.ActiveStep.FindControl("UserProfile1");
                    if (userProfile != null)
                    {
            ...
            if (redir != null && redir.Trim().Length > 0)
            {
                if (!redir.StartsWith("/Admin"))
                {
                    if(redir.ToLower().IndexOf("confirmation.aspx") != -1)
                        base.Redirect("/Admin/ControlsFT/EditProfile.aspx");
                    else
                        base.Redirect(redir);
                }
                else
        ...
        protected void CreateUserWizard1_SendingMail(object sender, MailMessageEventArgs e)
        {
            ...
            try
           {
               e.Message.Body = e.Message.Body.Replace("<% userWebInfo %>", base.UserAgentInformation);
        ...
        protected void CreateUserWizard1_CreatingUser(object sender, LoginCancelEventArgs e)
        {
            ...
            Label failure = (Label)step.ContentTemplateContainer.FindControl("ErrorMessage");
        ...
        protected void Login1_LoggedIn(object sender, EventArgs e)
        {
            ...
            if (redirect == null || redirect.Trim().Length == 0 || (redirect.ToLower().IndexOf("confirmation.aspx") != -1) || (redirect.ToLower().IndexOf("shipping.aspx") != -1)
                || (redirect.ToLower().IndexOf("passwordrecovery") != -1))
                base.Redirect("/Admin/ControlsFT/EditProfile.aspx");
        }
        ...
        protected void Login1_LoginError(object sender, EventArgs e)
        {
            ...
            {
                updateProfile.Text = "Please update your profile by creating a new account.";
                existing.Visible = false;
            }
            else if (result != null && result.ToString().ToLower() == "true")
            {
                EventQ.LogEvent(DateTime.Now, DateTime.Now, _Enums.EventQStatus.Failed, login.UserName, Guid.Empty, login.UserName,
                    _Enums.EventQContext.User, _Enums.EventQVerb.UserLogin, login.Password, "Invalid password", null);
            }
        }
