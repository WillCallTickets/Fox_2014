<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EditPost_Content.ascx.cs" Inherits="wctMain.Admin._collectionEditors._post._controls.EditPost_Content" %>
        ...
        <EditItemTemplate>            
            <div class="form-group">
                <div class="input-group">
                    <uc2:WctCkEditor ID="WctCkEditor1" runat="server" Width="750px" Height="600" Rows="10" Text='<%#Eval("ValueX") %>' />
                </div>
            </div>
